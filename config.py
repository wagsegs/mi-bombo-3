...
LORE_MIN_PARTICIPANTS = int(os.getenv("LORE_MIN_PARTICIPANTS", "2"))
LORE_MIN_MESSAGES = int(os.getenv("LORE_MIN_MESSAGES", "8"))
LORE_MAX_AVERAGE_REPLY_GAP_SECONDS = int(os.getenv("LORE_MAX_AVERAGE_REPLY_GAP_SECONDS", "90"))
LORE_MIN_DURATION_SECONDS = int(os.getenv("LORE_MIN_DURATION_SECONDS", "60"))
LORE_FLEXIBLE_MESSAGE_COUNT = int(os.getenv("LORE_FLEXIBLE_MESSAGE_COUNT", "10"))
LORE_FLEXIBLE_MIN_PARTICIPANTS = int(os.getenv("LORE_FLEXIBLE_MIN_PARTICIPANTS", "2"))
LORE_FLEXIBLE_MIN_DURATION_SECONDS = int(os.getenv("LORE_FLEXIBLE_MIN_DURATION_SECONDS", "45"))
LORE_FLEXIBLE_MAX_AVERAGE_REPLY_GAP_SECONDS = int(os.getenv("LORE_FLEXIBLE_MAX_AVERAGE_REPLY_GAP_SECONDS", "90"))
